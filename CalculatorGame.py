...
time.sleep(0.3)
print()
print("Getting an answer correct gives you points (25) but getting one incorrect takes points away (20).")
time.sleep(0.3)
print()
print("If you don't answer a question in time, you will get it incorrect (affected by difficulty)")
time.sleep(0.3)
print()
